...
# Aglomerados Subnormais nao atendidos ------------------------------------
    ...
    aglomerados_natend500 <- aglomerados_natend500 %>%
...
# Cleveland de Frequencia -------------------------------------------------
    ...
    ggsave(p_head_bus,
           device = "png",
           filename =  sprintf("../data/map_plots_transports/muni_%s/15-linhasbus_freq_cleveland_%s.png", sigla_muni, sigla_muni),
           dpi = 400,
           width = 15, height = 10, units = "cm" )
